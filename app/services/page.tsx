...
export const metadata: Metadata = {
  ...
  description:
    'מגוון שירותים לחיית המחמד שלכם: קבורה בחלקה לבחירתכם, שירותי קרמטוריום, הקמת מצבה אישית, הסעות, ופינת מבקרים. ליווי אישי 24/7.',
};
...
const services = [
  ...
  },
  {
    ...
    description:
      'אנו מקדישים תשומת לב יומיומית לתחזוקת החלקות, ניקיון, גינון, השקיה וטיפוח המצבות. דניאל מתגורר בחווה ומבצע השגחה צמודה 24/7 — אתם יכולים להיות שקטים שמקום המנוחה של חיית המחמד שלכם נשמר בכבוד לאורך השנים.',
  },
];
